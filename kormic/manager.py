...
class AgentManager:
    ...
    def register_new_agent(
        ...
        if agent_type == "BLD":
            if not artifact_signature or not vendor_pub_key:
                raise ValueError("BAIN registration requires artifact binding (vendor_pub_key and artifact_signature).")
            from kormic.crypto.algorithms import MLDSASigner
            payload = (entity_ref + instance_num).encode('utf-8')
            try:
